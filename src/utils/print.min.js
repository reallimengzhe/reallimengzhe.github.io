      ...
      function (e, t, n) {
                  ...
                  n.setAttribute(
                    ...
                    (function (e, t) {
                      for (var n = '', r = (document.defaultView || window).getComputedStyle(e, ''), o = 0; o < r.length; o++)
                        (-1 !== t.targetStyles.indexOf('*') || -1 !== t.targetStyle.indexOf(r[o]) || c(t.targetStyles, r[o])) &&
          ...
          ;(e.properties = e.properties.map(function (t) {
            ...
            (e.printableElement.innerHTML += (function (e) {
              ...
              for (var o = 0; o < n.length; o++)
                r += '<th style="width:' + n[o].columnSize + ';' + e.gridHeaderStyle + '">' + d(n[o].displayName) + '</th>'
        ...
        var S = ['pdf', 'html', 'image', 'json', 'raw-html'],
          x = function () {
            ...
            if (!e.type || 'string' != typeof e.type || -1 === S.indexOf(e.type.toLowerCase()))
